...
final class Pojo_A11y_Frontend {
				...
				<div class="pojo-a11y-toolbar-inner">
					...
					<ul class="pojo-a11y-toolbar-items pojo-a11y-tools">
						...
						<?php if ( $this->is_toolbar_button_active( 'readable_font' ) ) : ?>
							<li class="pojo-a11y-toolbar-item">
								<a href="#" class="pojo-a11y-toolbar-link pojo-a11y-btn-readable-font" data-action="readable-font" data-action-group="font" tabindex="-1" role="button">
									<?php echo $this->get_toolbar_button_title( 'readable_font' ); ?>
								</a>
							</li>
						<?php endif; ?>
						
                        <?php if ( $this->is_toolbar_button_active( 'opendyslexic' ) ) : ?>
                            <li class="pojo-a11y-toolbar-item">
                                <a href="#" class="pojo-a11y-toolbar-link pojo-a11y-btn-opendyslexic" data-action="opendyslexic" data-action-group="font" tabindex="-1" role="button">
                                    <?php echo $this->get_toolbar_button_title( 'opendyslexic' ); ?>
                                </a>
                            </li>
                        <?php endif; ?>
	...
	private function get_toolbar_svg( $icon, $icon_title = '' ) {
		$icons = [
			...
			'opendyslexic' => '<path fill="currentColor" d="M181.25 139.75l-42.5 112.5c24.75 0.25 49.5 1 74.25 1 4.75 0 9.5-0.25 14.25-0.5-13-38-28.25-76.75-46-113zM0 416l0.5-19.75c23.5-7.25 49-2.25 59.5-29.25l59.25-154 70-181h32c1 1.75 2 3.5 2.75 5.25l51.25 120c18.75 44.25 36 89 55 133 11.25 26 20 52.75 32.5 78.25 1.75 4 5.25 11.5 8.75 14.25 8.25 6.5 31.25 8 43 12.5 0.75 4.75 1.5 9.5 1.5 14.25 0 2.25-0.25 4.25-0.25 6.5-31.75 0-63.5-4-95.25-4-32.75 0-65.5 2.75-98.25 3.75 0-6.5 0.25-13 1-19.5l32.75-7c6.75-1.5 20-3.25 20-12.5 0-9-32.25-83.25-36.25-93.5l-112.5-0.5c-6.5 14.5-31.75 80-31.75 89.5 0 19.25 36.75 20 51 22 0.25 4.75 0.25 9.5 0.25 14.5 0 2.25-0.25 4.5-0.5 6.75-29 0-58.25-5-87.25-5-3.5 0-8.5 1.5-12 2-15.75 2.75-31.25 3.5-47 3.5z"></path>',
