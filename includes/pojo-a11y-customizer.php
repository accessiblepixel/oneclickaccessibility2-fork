...
class Pojo_A11y_Customizer {
	...
	public function get_customizer_fields() {
		...
		$fields[] = [
			'id'          => 'a11y_colour_text_or_picker',
			'title'       => __( 'Colour Setting', 'pojo-accessibility' ),
			'type'        => 'select',
			'choices'     => [
				'color'   => __( 'Color Picker', 'pojo-accessibility' ),
				'text' 	  => __( 'Text Entry', 'pojo-accessibility' ),
			],
			'std'         => 'color',
			'description' => __( 'Set Toolbar Position', 'pojo-accessibility' ),
		];
		$fields[] = [
			...
			'type'        => '$customizer_options['a11y_colour_text_or_picker']',
			'std'         => '#ffffff',
